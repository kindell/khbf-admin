...
interface SMSLoginProps {
  onLoginSuccess: (memberId: string, memberName: string) => void;
}

type LoginStep = 'phone' | 'code';

export function SMSLogin({ onLoginSuccess }: SMSLoginProps) {
  ...
  async function handleVerifyCode(e: React.FormEvent) {
    ...
    try {
      ...
      // Success!
      onLoginSuccess(data.member_id, data.member_name);
